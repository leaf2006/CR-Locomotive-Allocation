...
import httpx
from format import get_webfetch_data, get_detail_data
...
async def _first_normal_data_processing(
    ...
    async with semaphore:
        ...
        get_webfetch_data(index_response.text, "normal_fetch", url, store_dict, first_raw_result, detail_fetch_urls)
...
async def index_first_web_fetch(fetch_url) -> list[str]:
    ...
    # return list(data)
    return first_raw_result, detail_fetch_urls
